...
class TagTests(common.AegisTestCase):
    ...
    def test_root_create_tag(self):
        ...
        self.assertEqual([ "a" ], self.get("tags/a", USER_ROOT).json()["key"])
    ...
    def test_root_create_tags(self):
        self.assertEqual(200, self.put("tags/a", USER_ROOT).status_code)
        self.assertEqual(200, self.put("tags/b", USER_ROOT).status_code)
        self.assertEqual(200, self.put("tags/c", USER_ROOT).status_code)
