...
class ProjectTests(common.AegisTestCase):
    ...
    def test_root_create_project(self):
        ...
        self.assertEqual([ "a" ], self.get("projects/a", USER_ROOT).json()["key"])

        list = self.get("projects", USER_ROOT).json()
    ...
    def test_root_create_projects(self):
        self.assertEqual(200, self.put("projects/a", USER_ROOT).status_code)
        self.assertEqual(200, self.put("projects/b", USER_ROOT).status_code)
        self.assertEqual(200, self.put("projects/c", USER_ROOT).status_code)
    ...
    def test_root_create_nested_project(self):
        self.assertEqual(200, self.put("projects/a", USER_ROOT).status_code)
        self.assertEqual(200, self.put("projects/a/b", USER_ROOT).status_code)

        self.assertEqual("a/b", self.get("projects/a/b", USER_ROOT).json()["path"])
    ...
    def test_root_delete_nested_project(self):
        self.assertEqual(200, self.put("projects/a", USER_ROOT).status_code)
        self.assertEqual(200, self.put("projects/a/b", USER_ROOT).status_code)
        self.assertEqual(200, self.put("projects/a/b/c", USER_ROOT).status_code)
